#!/usr/bin/env python3
"""Verifica que A_quineladel44_v8.html y B_quinelacsm_v8.html sean idénticos
...
A = os.path.join(ROOT, 'A_quineladel44_v8.html')
B = os.path.join(ROOT, 'B_quinelacsm_v8.html')
